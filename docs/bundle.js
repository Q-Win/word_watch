...
function formatWord(word, count){
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#top-word").empty();
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#top-word").append(`<h3>${word} is used a total ${count} times</h3>`)
}
